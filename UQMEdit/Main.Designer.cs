...
namespace UQMEdit
{
	partial class Main
	{
		...
		private void InitializeComponent() {
			...
			this.IncrWidthLabel = new System.Windows.Forms.Label();
			this.IncrWidth = new System.Windows.Forms.NumericUpDown();
			this.ErrorHeightLabel = new System.Windows.Forms.Label();
			this.ErrorHeight = new System.Windows.Forms.NumericUpDown();
			this.ErrorWidthLabel = new System.Windows.Forms.Label();
			this.ErrorWidth = new System.Windows.Forms.NumericUpDown();
			this.FractHeightLabel = new System.Windows.Forms.Label();
			this.FractHeight = new System.Windows.Forms.NumericUpDown();
			this.FractWidthLabel = new System.Windows.Forms.Label();
			this.FractWidth = new System.Windows.Forms.NumericUpDown();
			this.VectorHeightLabel = new System.Windows.Forms.Label();
			this.VectorHeight = new System.Windows.Forms.NumericUpDown();
			this.VectorWidth = new System.Windows.Forms.NumericUpDown();
			...
			this.CombatSpeedLabel = new System.Windows.Forms.Label();
			...
			((System.ComponentModel.ISupportInitialize)(this.FractHeight)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.FractWidth)).BeginInit();
			...
			// TotalMinerals
			// 
			this.TotalMinerals.Increment = new decimal(new int[] {
            0,
            0,
            0,
            0});
			...
			this.Extras.Size = new System.Drawing.Size(863, 474);
			...
			// 
			this.ElementWorthGroupBox.Controls.Add(this.ExoticWorthLabel);
			this.ElementWorthGroupBox.Controls.Add(this.RadioactiveWorthLabel);
			this.ElementWorthGroupBox.Controls.Add(this.PreciousMetalWorthLabel);
			this.ElementWorthGroupBox.Controls.Add(this.RareEarthWorthLabel);
			this.ElementWorthGroupBox.Controls.Add(this.NobleGasWorthLabel);
			this.ElementWorthGroupBox.Controls.Add(this.baseMetalWorthLabel);
			this.ElementWorthGroupBox.Controls.Add(this.CorrosiveWorthLabel);
			this.ElementWorthGroupBox.Controls.Add(this.CommonWorthLabel);
			this.ElementWorthGroupBox.Controls.Add(this.ExoticWorth);
			this.ElementWorthGroupBox.Controls.Add(this.RadioactiveWorth);
			this.ElementWorthGroupBox.Controls.Add(this.PreciousMetalWorth);
			this.ElementWorthGroupBox.Controls.Add(this.RareEarthWorth);
			this.ElementWorthGroupBox.Controls.Add(this.NobleGasWorth);
			this.ElementWorthGroupBox.Controls.Add(this.BaseMetalWorth);
			this.ElementWorthGroupBox.Controls.Add(this.CorrosiveWorth);
			this.ElementWorthGroupBox.Controls.Add(this.CommonWorth);
			this.ElementWorthGroupBox.Location = new System.Drawing.Point(495, 6);
			this.ElementWorthGroupBox.Name = "ElementWorthGroupBox";
			...
			// ExoticWorthLabel
			// 
			this.ExoticWorthLabel.AutoSize = true;
			this.ExoticWorthLabel.ForeColor = System.Drawing.Color.Purple;
			this.ExoticWorthLabel.Location = new System.Drawing.Point(6, 205);
			this.ExoticWorthLabel.Name = "ExoticWorthLabel";
			this.ExoticWorthLabel.Size = new System.Drawing.Size(41, 13);
			this.ExoticWorthLabel.TabIndex = 31;
			this.ExoticWorthLabel.Text = "Exotics";
			// 
			// RadioactiveWorthLabel
			// 
			this.RadioactiveWorthLabel.AutoSize = true;
			this.RadioactiveWorthLabel.ForeColor = System.Drawing.Color.Orange;
			this.RadioactiveWorthLabel.Location = new System.Drawing.Point(6, 179);
			this.RadioactiveWorthLabel.Name = "RadioactiveWorthLabel";
			this.RadioactiveWorthLabel.Size = new System.Drawing.Size(69, 13);
			this.RadioactiveWorthLabel.TabIndex = 30;
			this.RadioactiveWorthLabel.Text = "Radioactives";
			// 
			// PreciousMetalWorthLabel
			// 
			this.PreciousMetalWorthLabel.AutoSize = true;
			this.PreciousMetalWorthLabel.ForeColor = System.Drawing.Color.Gold;
			this.PreciousMetalWorthLabel.Location = new System.Drawing.Point(6, 153);
			this.PreciousMetalWorthLabel.Name = "PreciousMetalWorthLabel";
			this.PreciousMetalWorthLabel.Size = new System.Drawing.Size(82, 13);
			this.PreciousMetalWorthLabel.TabIndex = 29;
			this.PreciousMetalWorthLabel.Text = "Precious Metals";
			// 
			// RareEarthWorthLabel
			// 
			this.RareEarthWorthLabel.AutoSize = true;
			this.RareEarthWorthLabel.ForeColor = System.Drawing.Color.Green;
			this.RareEarthWorthLabel.Location = new System.Drawing.Point(6, 127);
			this.RareEarthWorthLabel.Name = "RareEarthWorthLabel";
			this.RareEarthWorthLabel.Size = new System.Drawing.Size(63, 13);
			this.RareEarthWorthLabel.TabIndex = 28;
			this.RareEarthWorthLabel.Text = "Rare Earths";
			// 
			// NobleGasWorthLabel
			// 
			this.NobleGasWorthLabel.AutoSize = true;
			this.NobleGasWorthLabel.ForeColor = System.Drawing.Color.Blue;
			this.NobleGasWorthLabel.Location = new System.Drawing.Point(6, 101);
			this.NobleGasWorthLabel.Name = "NobleGasWorthLabel";
			this.NobleGasWorthLabel.Size = new System.Drawing.Size(68, 13);
			this.NobleGasWorthLabel.TabIndex = 27;
			this.NobleGasWorthLabel.Text = "Noble Gases";
			// 
			// baseMetalWorthLabel
			// 
			this.baseMetalWorthLabel.AutoSize = true;
			this.baseMetalWorthLabel.ForeColor = System.Drawing.Color.Gray;
			this.baseMetalWorthLabel.Location = new System.Drawing.Point(6, 75);
			this.baseMetalWorthLabel.Name = "baseMetalWorthLabel";
			this.baseMetalWorthLabel.Size = new System.Drawing.Size(65, 13);
			this.baseMetalWorthLabel.TabIndex = 26;
			this.baseMetalWorthLabel.Text = "Base Metals";
			// 
			// CorrosiveWorthLabel
			// 
			this.CorrosiveWorthLabel.AutoSize = true;
			this.CorrosiveWorthLabel.ForeColor = System.Drawing.Color.Red;
			this.CorrosiveWorthLabel.Location = new System.Drawing.Point(6, 49);
			this.CorrosiveWorthLabel.Name = "CorrosiveWorthLabel";
			this.CorrosiveWorthLabel.Size = new System.Drawing.Size(51, 13);
			this.CorrosiveWorthLabel.TabIndex = 25;
			this.CorrosiveWorthLabel.Text = "Corrosive";
			// 
			// CommonWorthLabel
			// 
			this.CommonWorthLabel.AutoSize = true;
			this.CommonWorthLabel.ForeColor = System.Drawing.Color.Cyan;
			this.CommonWorthLabel.Location = new System.Drawing.Point(6, 23);
			this.CommonWorthLabel.Name = "CommonWorthLabel";
			this.CommonWorthLabel.Size = new System.Drawing.Size(48, 13);
			this.CommonWorthLabel.TabIndex = 24;
			this.CommonWorthLabel.Text = "Common";
			// 
			// ExoticWorth
			// 
			...
			this.ExoticWorth.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			// RadioactiveWorth
			// 
			...
			this.RadioactiveWorth.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			// PreciousMetalWorth
			// 
			...
			this.PreciousMetalWorth.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			// RareEarthWorth
			// 
			...
			this.RareEarthWorth.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			// NobleGasWorth
			// 
			...
			this.NobleGasWorth.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			// BaseMetalWorth
			// 
			...
			this.BaseMetalWorth.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			// CorrosiveWorth
			// 
			...
			this.CorrosiveWorth.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			// CommonWorth
			// 
			...
			// FuelCost
			// 
			this.FuelCost.Increment = new decimal(new int[] {
            0,
            0,
            0,
            0});
			...
			this.GlobalFlagsGroupBox.Size = new System.Drawing.Size(244, 181);
			...
			// 
			this.SubtitleSpeedGroupBox.Controls.Add(this.ReadSpeedLabel);
			...
			this.ReadSpeed.ValueChanged += new System.EventHandler(this.ReadSpeedChanged);
			// 
			// MusicSoundGroupBox
			// 
			...
			// CyborgGroupBox
			// 
			this.CyborgGroupBox.Controls.Add(this.CombatSpeedLabel);
			...
			this.CyborgGroupBox.Size = new System.Drawing.Size(118, 73);
			...
			this.CombatSpeed.Location = new System.Drawing.Point(6, 19);
			...
			((System.ComponentModel.ISupportInitialize)(this.IncrWidth)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.FractHeight)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.FractWidth)).EndInit();
		...
		private System.Windows.Forms.Label PreciousMetalWorthLabel;
		private System.Windows.Forms.Label RareEarthWorthLabel;
		private System.Windows.Forms.Label NobleGasWorthLabel;
		private System.Windows.Forms.Label baseMetalWorthLabel;
		private System.Windows.Forms.Label CorrosiveWorthLabel;
		private System.Windows.Forms.Label CommonWorthLabel;
		public System.Windows.Forms.NumericUpDown ExoticWorth;
		public System.Windows.Forms.NumericUpDown RadioactiveWorth;
		public System.Windows.Forms.NumericUpDown PreciousMetalWorth;
		public System.Windows.Forms.NumericUpDown RareEarthWorth;
		public System.Windows.Forms.NumericUpDown NobleGasWorth;
